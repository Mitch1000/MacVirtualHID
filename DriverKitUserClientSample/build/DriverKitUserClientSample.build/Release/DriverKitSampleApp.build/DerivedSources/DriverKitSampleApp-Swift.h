...
#ifndef DRIVERKITSAMPLEAPP_SWIFT_H
#define DRIVERKITSAMPLEAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DriverKitSampleApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC18DriverKitSampleApp22DriverLoadingViewModel")
@interface DriverLoadingViewModel : NSObject
...
@interface DriverLoadingViewModel (SWIFT_EXTENSION(DriverKitSampleApp)) <OSSystemExtensionRequestDelegate>
